...
private extension Scrypt.Parameters {
    var p: Int { return parallelizationParameter }
    var r: Int { return blockSize }
    var n: Int { return costParameter }
    var desiredKeyLength: Int { return lengthOfDerivedKey }
}


// Scrypt implementation found in TrustWallet: https://github.com/TrustWallet/trust-keystore/blob/master/Sources/Scrypt.swift
// which is based on [Colin Percival's reference implementation](https://www.tarsnap.com/scrypt/scrypt.pdf)
...
public final class Scrypt {
    ...
    public typealias ScryptParams = Scrypt.Parameters
