...
//        NavigationView {
//            List {
//                navigationLink(tag: .balances) { BalancesScreen() }
//                navigationLink(tag: .transfer) { TransferScreen() }
//                navigationLink(tag: .contacts) { ContactsScreen() }
//                navigationLink(tag: .settings) { SettingsScreen() }
//            }
